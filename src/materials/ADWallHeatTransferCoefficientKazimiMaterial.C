...
#include "ADWallHeatTransferCoefficientKazimiMaterial.h"
#include "SinglePhaseFluidProperties.h"
#include "FlowModelSinglePhase.h"
#include "Numerics.h"

registerMooseObject("MIFTAPApp", ADWallHeatTransferCoefficientKazimiMaterial);
...
ADWallHeatTransferCoefficientKazimiMaterial::validParams()
{
  ...
  params.addClassDescription(" Computes wall heat transfer coefficient for liquid sodium using "
                             "Kazimi-Carelli correlation");
  return params;
}

ADWallHeatTransferCoefficientKazimiMaterial::ADWallHeatTransferCoefficientKazimiMaterial(
...
ADWallHeatTransferCoefficientKazimiMaterial::computeQpProperties()
{
  ...
  {
    mooseDoOnce(mooseWarning("The Kazimi-Carelli correlation is valid when Pe is between 10 and "
                             "5000, and P/D is between 1.1 "
                             "and 1.4. Be aware that using values out of this range may lead to "
