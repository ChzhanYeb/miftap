...
registerMooseAction("MIFTAPApp", CoupledHeatTransferAction, "add_bc");
registerMooseAction("MIFTAPApp", CoupledHeatTransferAction, "add_user_object");
registerMooseAction("MIFTAPApp", CoupledHeatTransferAction, "add_transfer");
