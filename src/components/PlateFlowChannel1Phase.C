...
InputParameters
PlateFlowChannel1Phase::validParams()
{
...
PlateFlowChannel1Phase::PlateFlowChannel1Phase(const InputParameters & params)
...
PlateFlowChannel1Phase::buildFlowModel()
{
...
void
PlateFlowChannel1Phase::check() const
{
...
void
PlateFlowChannel1Phase::addMooseObjects()
{
...
void
PlateFlowChannel1Phase::addHydraulicDiameterMaterial()
{
...
void
PlateFlowChannel1Phase::getHeatTransferVariableNames()
{
